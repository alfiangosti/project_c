...
*/
	...
	ch[2] = MakeButton("   2   ", afficher2, vc);
	ch[3] = MakeButton("   3   ", afficher3, vc);
	ch[4] = MakeButton("   4   ", afficher4, vc);
	ch[5] = MakeButton("   5   ", afficher5, vc);
	ch[6] = MakeButton("   6   ", afficher6, vc);
	ch[7] = MakeButton("   7   ", afficher7, vc);
	ch[8] = MakeButton("   8   ", afficher8, vc);
	ch[9] = MakeButton("   9   ", afficher9, vc);
